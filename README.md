...
| hactool / nstool | hactool 1.x ([borntohonk fork](https://github.com/borntohonk/hactool), builds on macOS) or nstool 1.9.2 | one-time extraction: game dump → NCA → ExeFS → decompressed NSO (needs `prod.keys`/`title.keys` from your console) |
